try:
    ...
    #play sound on this computer
    # winsound.Beep(2015,3000)
    # speak.Speak("Program Failed to Excecute. A run-time error orrurs")
    try:
        #send a desktop message to this computer
        toaster = ToastNotifier()
        toaster.show_toast("Program Failed to Excecute","A run-time error orrurs after "+str(time.time() - start_time)+"s.")
        
        #send a message to iphone pushover
        init("avf2ozva1ptdir7caubhvgff1sm6o2")
        Client("u6x9d8dfz493h4ixf775ow3edky6jy").send_message("A run-time error orrurs after "+str(time.time() - start_time)+"s.",title="Program Failed to Excecute")
    except:
        #send a desktop message to this computer
        toaster = ToastNotifier()
        toaster.show_toast("Program Failed to Excecute","A run-time error orrurs.")
        
        #send a message to iphone pushover
        init("avf2ozva1ptdir7caubhvgff1sm6o2")
        Client("u6x9d8dfz493h4ixf775ow3edky6jy").send_message("A run-time error orrurs.",title="Program Failed to Excecute")